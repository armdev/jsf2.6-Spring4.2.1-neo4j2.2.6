...
import com.neo.domain.Movie;
import com.neo.domain.User;
import com.neo.domain.Viewing;
...
public class SocialNetworkUniverse {
    ...
    /**
     * Configure (by adding friends) the known friend of friends scenario
     */
    ...
    /**
     * Validate that the friends of friends setup has been done correctly
     */
    ...
    /**
     * Load a particular user and check whether their friends match those which
     * are expected.
     */
